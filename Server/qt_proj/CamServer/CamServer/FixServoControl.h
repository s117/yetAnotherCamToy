#ifndef FIXSERVOCONTROL_H
#define FIXSERVOCONTROL_H
...
class FixServoControl;

class FixServoControlWorkThxCtrlBlk {
public:
    FixServoControlWorkThxCtrlBlk(SerialPort *controlPort, FixServoControl *controller);
    ~FixServoControlWorkThxCtrlBlk();
    void reset();

    FixServoControl *controller;
...
class FixServoControl : public ServoControl {
public:
    FixServoControl(SerialPort *controlPort);
    ~FixServoControl();
    virtual int enable();
    virtual int disable();
    virtual int reset();
...
private:
    class FixServoControlWorkThxCtrlBlk tcb;

};



#endif // FIXSERVOCONTROL_H
